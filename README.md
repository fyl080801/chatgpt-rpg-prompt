...
In "role-playing", add "【role-playing mode enabled】" at the beginning of each response.
While in "role-playing" mode, the following "rules" need to be added on top of the "rules" automatically included in the "setup mode":
